...
* Family income partitioned into different schemes for use in different modeling specifications, and for alignment to values that CCDF income eligibility thresholds may take on:
  - 0-50% FPL, 50-125%, 125-185%, 185-300%, 300%+ (useful in contexts where the CCDF income eligibility threshold is 185% FPL)
  - 0-50% FPL, 50-100%, 100-200%, 200-300%, 300%+ (useful in contexts where the CCDF income eligibility threshold is 200% FPL)
  - 0-75% FPL, 75-150%, 150-225%, 225-300%, 300%+ (useful in contexts where the CCDF income eligibility threshold is 225% FPL)
  - 0-50% FPL, 50-100%, 100-150%, 150-200%, 200-250%, 250-300%, 300%+ (useful for flexibility despite buckets with relatively few households)
  - 0-100% FPL, 100-200%, 200-300%, 300%+ (useful for simpler reference)
...
acs1_child_mod <- 
  acs1_child %>% 
  .[j = child_agegroup_combo := case_when(child_agegroup %in% c("0to2", "3to5") ~ "0to5",
                                          TRUE ~ child_agegroup)] %>% 
  .[order(child_agegroup_combo, PUMA)]
