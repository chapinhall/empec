...
cps_child_base_post <- 
  ...
  mutate(
         ...
         share_0_75    = 1*(fam_incpov_ratio_cat_by75_adj  == "0%-75%"),
         ...
         share_100_150 = 1*(fam_incpov_ratio_cat_by50_adj  == "100%-150%"),
         share_100_200 = 1*(fam_incpov_ratio_cat_by100_adj == "100%-200%"),
         share_125_185 = 1*(fam_incpov_ratio_cat_to185_adj == "125%-185%"),
         share_150_200 = 1*(fam_incpov_ratio_cat_by50_adj  == "150%-200%"),
         share_150_225 = 1*(fam_incpov_ratio_cat_by75_adj  == "150%-225%"),
         share_185_300 = 1*(fam_incpov_ratio_cat_to185_adj == "185%-300%"),
         share_200_250 = 1*(fam_incpov_ratio_cat_by50_adj  == "200%-250%"),
         share_200_300 = 1*(fam_incpov_ratio_cat_by100_adj == "200%-300%"),
         share_225_300 = 1*(fam_incpov_ratio_cat_by75_adj  == "225%-300%"),
         share_250_300 = 1*(fam_incpov_ratio_cat_by50_adj  == "250%-300%"),
         share_300_400 = 1*(fam_incpov_ratio_cat_by100_adj == "300%-400%"),
         share_400     = 1*(fam_incpov_ratio_cat_by100_adj == "400%+"),
         
         # Develop income measures for the HS-aligned CCDF categories
         share_100_ccdf = 1*(fam_incpov_ratio_cat_hs_ccdf_adj == glue("100%-{local_ccdf_thresh}%")),
         share_ccdf_350 = 1*(fam_incpov_ratio_cat_hs_ccdf_adj == glue("{local_ccdf_thresh}%-350%")),
         share_350_500  = 1*(fam_incpov_ratio_cat_hs_ccdf_adj == "350%-500%"),
         share_500      = 1*(fam_incpov_ratio_cat_hs_ccdf_adj == "500%+"),
         
         # Develop interactions
         share_NotWorkElig_0_100    = (1 - ccdf_elig_loose)*share_0_100,
         share_NotWorkElig_100_ccdf = (1 - ccdf_elig_loose)*share_100_ccdf,
         share_NotWorkElig_ccdf_350 = (1 - ccdf_elig_loose)*share_ccdf_350,
         share_NotWorkElig_350_500  = (1 - ccdf_elig_loose)*share_350_500,
         share_NotWorkElig_500      = (1 - ccdf_elig_loose)*share_500,
         share_WorkElig_0_100       =      ccdf_elig_loose *share_0_100,
         share_WorkElig_100_ccdf    =      ccdf_elig_loose *share_100_ccdf,
         share_WorkElig_ccdf_350    =      ccdf_elig_loose *share_ccdf_350,
         share_WorkElig_350_500     =      ccdf_elig_loose *share_350_500,
         share_WorkElig_500         =      ccdf_elig_loose *share_500)

to_rename <- str_subset(cn(cps_child_base_post), "share_.+_ccdf")
new_names <- str_replace(to_rename, "ccdf", as.character(local_ccdf_thresh))
  
setnames(cps_child_base_post,
         old = to_rename,
         new = new_names)
...
if (local_ccdf_thresh == 185) {
  cps_child_base_post <- 
    ...
    mutate(share_NotWorkElig_0_50    = (1 - ccdf_elig_loose)*share_0_50,
           ...
           share_NotWorkElig_300_400 = (1 - ccdf_elig_loose)*share_300_400,
           share_NotWorkElig_400     = (1 - ccdf_elig_loose)*share_400,
           ...
           share_WorkElig_300_400    =      ccdf_elig_loose *share_300_400,
           share_WorkElig_400        =      ccdf_elig_loose *share_400)
  ccdf_spec_vars <- 
    str_subset(cn(cps_child_base_post),
               "share_(Not)?WorkElig_(0_50|50_125|125_185|185_300|300_400|400)")
  
} else if (local_ccdf_thresh == 200) {
  cps_child_base_post <- 
    cps_child_base_post %>% 
    mutate(share_NotWorkElig_0_50    = (1 - ccdf_elig_loose)*share_0_50,
           share_NotWorkElig_50_100  = (1 - ccdf_elig_loose)*share_50_100,
           share_NotWorkElig_100_200 = (1 - ccdf_elig_loose)*share_100_200,
           share_NotWorkElig_200_300 = (1 - ccdf_elig_loose)*share_200_300,
           share_NotWorkElig_300_400 = (1 - ccdf_elig_loose)*share_300_400,
           share_NotWorkElig_400     = (1 - ccdf_elig_loose)*share_400,
           share_WorkElig_0_50       =      ccdf_elig_loose *share_0_50,
           share_WorkElig_50_100     =      ccdf_elig_loose *share_50_100,
  ...
  ccdf_spec_vars <- 
    str_subset(cn(cps_child_base_post),
               "share_(Not)?WorkElig_(0_50|50_100|100_200|200_300|300_400|400)")
  
} else if (local_ccdf_thresh == 225) {
  cps_child_base_post <- 
    cps_child_base_post %>% 
    mutate(share_NotWorkElig_0_75    = (1 - ccdf_elig_loose)*share_0_75,
  ...
  ccdf_spec_vars <- 
    str_subset(cn(cps_child_base_post),
               "share_(Not)?WorkElig_(0_75|75_150|150_225|225_300|300_400|400)")
}
```
...
transition_pred_vars_toadd_pov_mix <- 
  c("share_0_50", "share_50_100", "share_100_200", "share_200_300", "share_300_400", "share_400")

transition_pred_vars_toadd_pov_by100s <- 
  c("share_0_100", "share_100_200", "share_200_300", "share_300_400", "share_400")

transition_pred_vars_toadd_ccdf_elig_pov <- 
    str_subset(cn(cps_child_base_post),
               "share_(Not)?WorkElig_(0_100|100_ccdf|ccdf_350|350_500|500)") #/!\hk: since we changed the name in lines 431-436, not sure if this will detect the _ccdf part? Just double checking.
  # the prior specification, which was not necessarily aligned with 
  # poverty
  # ccdf_spec_vars 

transition_pred_vars_toadd_ccdf_elig_spouse <- 
  str_subset(colnames(cps_child_base_post),
             "share_(Not)?WorkElig_(No)?Spouse")
    ...
    for (sae_spec in specs) {
      ...
      if (str_detect(sae_spec, "^incpov")) {
        ...
        outcome_vars <- c("incpov_le50_post_adj", 
                          ...
                          "ccdf_elig_tight_inc_adj")
        if (str_detect(sae_spec, "incpov.+_100_")) {
          sae_controls <- transition_pred_vars_toadd_pov_by100s
        } else {
          sae_controls <- transition_pred_vars_toadd_pov_mix
        }
      } else if (str_detect(sae_spec, "^ccdf")) {
        outcome_vars <- "ccdf_elig_tight_inc_adj"
        if (str_detect(sae_spec, "wk_sp")) {
          sae_controls <- transition_pred_vars_toadd_ccdf_elig_spouse
        } else {
          sae_controls <- transition_pred_vars_toadd_ccdf_elig_pov
        }
      }
...
plot_trans_sensitivity_comp(nowcast_out[outcome_var == "incpov_le100_post_adj" & cps_base_recency == "most_recent"],
                            comp_col = "sae_spec",
                            base_val = "incpov_ctrls_mix_05") +
...
plot_trans_sensitivity_comp(nowcast_out[outcome_var == "incpov_le100_post_adj" & sae_spec == "incpov_ctrls_mix_05"],
