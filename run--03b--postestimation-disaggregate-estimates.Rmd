...
```{r function to develop top-level aggregation from microdata}
acs_fpl_agecounts <- 
  acs1_child %>%
  .[child_agegroup %in% c("0to2", "3to5") & !is.na(fam_incpov_ratio_cat_mix2) ] %>%
