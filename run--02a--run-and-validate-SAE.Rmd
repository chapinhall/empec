...
show_acs1_cat_density("work_incpov_statushs", 
...
show_acs1_cat_density_by_puma("work_incpov_statushs", 
                                glue("Combo of Family Work Eligibility for CCDF and Income-to-Poverty Aligned with the\nCCDF Threshold of {local_ccdf_thresh}% FPL"))
...
work_incpov_spec_field <- "work_incpov_statushs"

# Previously, we had custom breakpoints below `local_ccdf_thresh`. The new spec
# above ensures alignment with Head Start.

work_incpov_spec_field_alt <-
...
if (rerun_sae) {
  ...
  if (parallelize_sae) {
    ...
    sae_results_incpov_ctrls_100_05  <- run_saes_byCtrls(incpov_spec_field_mix,  acs1_child05_sae,  sae_controls_added_2534_05)
    sae_results_incpov_ctrls_100_612 <- run_saes_byCtrls(incpov_spec_field_mix,  acs1_child612_sae, sae_controls_added_2534_612)
