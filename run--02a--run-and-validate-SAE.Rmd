...
Below we see the size of the ACS1 sample partitioned by income-to-poverty cateogires defined by "100%"s. This is reasonably even at lower levels.
...
However, they differ for important reasons: even at the PUMA level they differ, and the fact that they differ reflects recency.
...
plot_puma_pops <- 
  ggplot(puma_agg_comp_pop,
         aes(x = n_acs1,
             ...
             group = PUMA)) +
  geom_point() + 
  geom_point(data = puma_agg_comp_pop %>% filter(PUMA == 2100),
             color = "red") + 
  geom_abline() +
  scale_x_continuous(limits = c(0, NA)) +
  scale_y_continuous(limits = c(0, NA)) +
