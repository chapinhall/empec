...
cps_pov <-
  ...
  .[j = `:=`(
             ...
             fam_incpov_ratio_cat_hs_ccdf_adj = bin_incpov_ratio(fam_incpov_ratio_adj, pov_breaks = c(0, 1.00, local_ccdf_incratio_base/100, 3.50, 5.00)),
...
cps_child_base <- 
  cps_elig[is_baseline == TRUE & between(AGE, 0, kid_age_thres_p+1)] %>% 
...
ggplot(cps_hoh_pre_post[YEAR_b == {base_year}],
       aes(faminc_draw_b,
           faminc_draw_p)) +
