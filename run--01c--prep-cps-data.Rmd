...
cps_pov <-
  ...
  .[j = `:=`(fam_incpov_ratio_cat_by50       = bin_incpov_ratio(fam_incpov_ratio,     pov_breaks = seq(0, 3, by = 0.50)),
             ...
             fam_incpov_ratio_cat_byMix2     = bin_incpov_ratio(fam_incpov_ratio,     pov_breaks = c(0, 1.0, 1.5, 2.25)),
             fam_incpov_ratio_cat_byMix2_adj = bin_incpov_ratio(fam_incpov_ratio_adj, pov_breaks = c(0, 1.0, 1.5, 2.25)),
             ...
             fam_incpov_ratio_le1.5      = 1*(fam_incpov_ratio     <= 1.5),
             fam_incpov_ratio_le1.5_adj  = 1*(fam_incpov_ratio_adj <= 1.5),
...
cps_child_base <- 
  ...
  .[j = .(CPSID, CPSIDP, WTFINL, HWTFINL, 
          YEAR, MONTH, YEAR_MONTH, AGE, is_validation, METRO, STATEFIP,
          ...
          fam_incpov_ratio_cat_byMix2, fam_incpov_ratio_cat_byMix2_adj,
...
cps_post <-
  cps_elig[is_post == TRUE & RELATE == 101 & months_since_base == 15,
           j = .(CPSID,
                 ...
                 le150_elig_post     = fam_incpov_ratio_le1.5,
                 ...
                 le150_elig_post_adj = fam_incpov_ratio_le1.5_adj,
