...
```{r get fpl threshold for ccdf for CPS calcs}
...
cps_pov <-
  ...
  .[j = `:=`(
             ...
             fam_incpov_ratio_cat_hs_ccdf_adj = bin_incpov_ratio(fam_incpov_ratio_adj, pov_breaks = c(0, 1.00, ccdf_inc_thresh_fpl/100, 4.00)),
