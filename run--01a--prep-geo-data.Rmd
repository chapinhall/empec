...
tractShp  <-   tracts(state = my_state_fip, cb = TRUE, year = tiger_year, progress_bar = FALSE, county = county_val)
pumaShp   <-    pumas(state = my_state_fip, cb = TRUE, year = tiger_year, progress_bar = FALSE) 
countyShp <- counties(state = my_state_fip, cb = TRUE, year = tiger_year, progress_bar = FALSE)
zctaShp   <-    zctas(cb = TRUE, year = tiger_year, starts_with = zcta_starts, progress_bar = FALSE)
