...
nowcast_parallel_ccdf_elig <- 
  ...
  mutate(base_share = share_WorkElig_0_100 + get(glue("share_WorkElig_100_{local_ccdf_thresh}")))

# This is the old scheme of custom breakpoints below the ccdf cutoff, which were
# not necessarily aligned with head start eligibility (of income of 100)
